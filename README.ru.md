...
- **Повторяемость**: повторное использование кэша по SHA-256 для неизменённых файлов.
- **Приватность при необходимости**: режим `sensitive` отключает preview и использует короткий TTL кэша.
